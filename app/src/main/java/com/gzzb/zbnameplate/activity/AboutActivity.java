...
import com.gzzb.zbnameplate.utils.system.UpdateUtil;
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case UPDATE_CODE:
                    ...
                    break;
                case IS_LATEST:
                    Toast.makeText(AboutActivity.this, "你的版本已是最新版", Toast.LENGTH_SHORT).show();
                    break;
            }
        }
    };
        ...
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton("赶紧升级", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        Toast.makeText(AboutActivity.this, "开始下载更新", Toast.LENGTH_SHORT).show();
                        UpdateUtil.download(AboutActivity.this, mUpdateInfo.downloadUrl, "无线桌牌新版本");
                    }
                })
