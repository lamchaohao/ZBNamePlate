...
public class SendDataUtil {
    public static final int UPDATE_PROGRESS = 0x11;
    public static final int WIFI_ERRO = 0x14;
    public static final int CONN_ERRO = 0x24;
        ...
        try {
            ...
            for (int i = 0; i < readMsg.length; i++) {
                if(testCMD[i]!=readMsg[i]){
                    mHandler.sendEmptyMessage(CONN_ERRO);
                }else {
                }
            }
